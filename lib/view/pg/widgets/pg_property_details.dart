...
class PgPropertyDetailsDialog extends StatelessWidget {
  final Property property;

  const PgPropertyDetailsDialog({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // 🏠 Property Details
              _buildDetailRow(
                  "Location", property.location, Icons.location_on_outlined),
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: () {
            context.read<PglistBloc>().add(PgApproveProperty(property));
        ...
        ElevatedButton(
          onPressed: () {
            ...
            context.read<PglistBloc>().add(PgRejectProperty(property));
            Navigator.pop(context);
          },
          style: ElevatedButton.styleFrom(
